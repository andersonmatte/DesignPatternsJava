package br.com.webmatte.criacao.builder.boletos;
 ...
 */
public class BanrisulBoleto implements Boleto {
    ...
    public BanrisulBoleto(String sacado, String cedente, Double valor, LocalDate vencimento, Integer nossoNumero) {
        this.sacado = sacado;
